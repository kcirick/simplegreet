...
static int 
write_req(int fd, struct json_object* req) 
{
...
static struct json_object* 
roundtrip_json(struct json_object* req) 
{
   struct json_object* resp = NULL;
   int fd;
...
const char* 
json_get_string_from_object(struct json_object* obj, const char* key) 
{
